...
" Plugins {
    ...
    " OmniComplete {
        ...
        if !exists('g:spf13_no_omni_complete')
            ...
            hi Pmenu  guifg=#078AAB guibg=#F8F8F8 ctermfg=darkcyan ctermbg=Lightgray
...
" GUI Settings {
    ...
    if has('gui_running')
        ...
        set lines=999 columns=999                " 40 lines of text instead of 24
        if !exists("g:spf13_no_big_font")
            if LINUX() && has("gui_running")
                set guifont=Andale\ Mono\ Regular\ 13,Menlo\ Regular\ 13,Consolas\ Regular\ 13,Courier\ New\ Regular\ 14
